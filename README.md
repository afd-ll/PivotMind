...
[![Version](https://img.shields.io/badge/version-v0.5.33-blue.svg)](changelogs/)
...
**Current version: v0.5.33.** This is a research project in the toy stage, not a replacement for a large language model or a production conversational system.
