...
echo === Compiling core sources (ASAN) ===
for %%f in (src\*.c) do (
    echo %%f
    gcc -Wall -Wextra -O1 -g -Iinclude -I. -Ilibs -std=gnu99 -fopenmp -pthread -MD -MP -D_USE_MATH_DEFINES -fsanitize=address -fno-omit-frame-pointer -MFbuild\dep\%%~nf.d -c %%f -o build\obj\%%~nf.o
    if errorlevel 1 echo FAILED: %%f & exit /b 1
)
echo === Compiling batch_learn.c (ASAN) ===
gcc -Wall -Wextra -O1 -g -Iinclude -I. -Ilibs -std=gnu99 -fopenmp -pthread -MD -MP -D_USE_MATH_DEFINES -fsanitize=address -fno-omit-frame-pointer -MFbuild\dep\batch_learn.d -c tools\batch_learn.c -o build\obj\batch_learn.o
...
echo === Linking batch_learn.exe (ASAN) ===
gcc -Wall -Wextra -O1 -g -Iinclude -I. -Ilibs -std=gnu99 -fopenmp -pthread -MD -MP -D_USE_MATH_DEFINES -fsanitize=address -fno-omit-frame-pointer -o build\bin\batch_learn.exe build\obj\batch_learn.o -L. -lpivotmind -lm
