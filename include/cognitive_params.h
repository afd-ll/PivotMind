...
/** 正则化常量 */
#define ACTIVATION_THRESHOLD 0.3f  // 激活阈值，低于此值视为无意义
#define DECAY_RATE 0.7f            // 衰减率，每跳传播衰减系数

/** 学习率常量 */
#define LEARN_RATE 0.005f  // EMA alpha，时间常数≈200轮

/** 安全保护常量 */
#define MAX_RECURSION_DEPTH 200  // 递归深度硬上限，防止visited满时循环→栈溢出
