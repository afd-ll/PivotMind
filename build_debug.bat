...
echo === Compiling core sources (DEBUG) ===
for %%f in (src\*.c) do (
    echo %%f
    gcc -Wall -Wextra -O0 -g -Iinclude -I. -Ilibs -std=gnu99 -fopenmp -pthread -MD -MP -D_USE_MATH_DEFINES -DDEBUG_HEAP -MFbuild\dep\%%~nf.d -c %%f -o build\obj\%%~nf.o
    if errorlevel 1 echo FAILED: %%f & exit /b 1
)
echo === Compiling batch_learn.c (DEBUG) ===
gcc -Wall -Wextra -O0 -g -Iinclude -I. -Ilibs -std=gnu99 -fopenmp -pthread -MD -MP -D_USE_MATH_DEFINES -DDEBUG_HEAP -MFbuild\dep\batch_learn.d -c tools\batch_learn.c -o build\obj\batch_learn.o
...
echo === Linking batch_learn.exe (DEBUG) ===
gcc -Wall -Wextra -O0 -g -Iinclude -I. -Ilibs -std=gnu99 -fopenmp -pthread -MD -MP -D_USE_MATH_DEFINES -DDEBUG_HEAP -o build\bin\batch_learn.exe build\obj\batch_learn.o -L. -lpivotmind -lm
